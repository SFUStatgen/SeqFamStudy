...
Let's draw a pedigree in `study_peds`, in the year 2020. We will take the 39th pedigree out of the 150 generated:

```{r}

plot(study_peds[study_peds$FamID == 39, ], ref_year = 2020,
     cex = 0.5)
