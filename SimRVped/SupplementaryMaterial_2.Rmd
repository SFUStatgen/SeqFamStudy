...
simulate exome-sequencing data in pedigrees ascertained to have four or more relatives affected with lymphoid cancer. The overall workflow for this project is shown below. This document focuses on the part of the flowchart labelled as
2 (the blue box).
