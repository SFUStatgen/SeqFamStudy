...
- This is the first RMarkdown document describing how we simulated exome-sequencing data in pedigrees ascertained for three or more relatives affected with lymphoid cancer. The following flow chart illustrates the overall workflow for this project. 
...
have occurred, affecting the genetic diversity [@Ragsdale2019]. The population-genetics literature has
several established demographic models inferred from genetic data [@Gutenkunst2009]. 

- We consider a demographic model in \texttt{stdpopsim}, the standard library of population-genetic 
simulation models [@10.7554/eLife.54967]. This library has around nine demographic models.  
