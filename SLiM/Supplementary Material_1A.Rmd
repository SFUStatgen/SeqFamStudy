...
\includegraphics[height = 0.9\textwidth , width = 1 \textwidth ]{Out of Africa model.jpg}
	\caption{The inferred Out-of-Africa demographic model [@Gravel2011].}
...
To run the SLiM script we write the following Slurm script, \texttt{job_serial.sh}: 
...
The content of \texttt{job_serial.sh} is described as follows.
...
frequences less than 1% in the TopMed study of the American population [@Taliun2021]. 
...
The following figure illustrates the allele frequency spectrum.
...
American population consisting of many more source populations. 
